...
namespace CloudComputingProject.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,Humidity,OrderDate,Temperature")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderId,Humidity,OrderDate,Temperature")] OrderDetail orderDetail)
        {
